...
A shopping list may also be considered to be a parent-child relationship.  "Buy
...
I choose to interpret a RRULE with BY\*-attributes set (like BYDAY=MO) as a
...
I have some more thoughts on project management over at the next-generation
CLI project, [plann](https://plann.no).
...
organize tasks over at [plann](https://plann.no).  To follow the
